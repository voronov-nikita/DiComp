...
- [ ] Расскажи о файле пустыше, жто может быть интресно
...
- [ ] Добавить уникальность сохранных данных, так чтобы не было повторений.

- [ ] Добавить возмодность сохранять одновременно несколько результатов функций.