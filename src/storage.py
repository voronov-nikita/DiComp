...
class Storage():
    ...
    def _addDatabase(self, user: str, servers: list) -> bool:
        '''
        ...
        в простивном случае вернется False.
        '''
        ...
        try:
            ...
            cursor.execute(f"""
            INSERT INTO files(user, servers) VALUES('{user}', '{serv}')
            """)
    ...
    def sendFile(self, file: str) -> None:
        '''
